...
// с отдельным FOV и всегда поверх.
namespace shooter_game.resources.render
{
    ...
    internal class FirstPersonRenderPass : CustomPass
    {
        ...
        protected override void Execute(CustomPassContext ctx)
        {
            ...
            foregroundCamera.transform.SetPositionAndRotation(currentCam.transform.position,
                cameraRotation);
            ...
            if (injectionPoint == CustomPassInjectionPoint.AfterOpaqueDepthAndNormal)
            {
                CoreUtils.SetKeyword(ctx.cmd, "WRITE_NORMAL_BUFFER", true);
                {
                    ...
                    RenderPassFromCamera(ctx, foregroundCamera, null, ctx.cameraDepthBuffer, ClearFlag.None,
                        foregroundMask, overrideMaterial: depthClearMaterial, overrideMaterialIndex: 0,
                        renderDepth: true);
            ...
            else
            {
                ...
                RenderPassFromCamera(ctx, foregroundCamera, ctx.cameraMotionVectorsBuffer, null, ClearFlag.None,
                    foregroundMask, overrideMaterial: depthClearMaterial, overrideMaterialIndex: 0, renderDepth: true);
            }
        }
